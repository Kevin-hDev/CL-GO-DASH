...
In den letzten Monaten haben wir unseren Fokus auf die Entwicklung von Basismodellen mit außergewöhnlichem Nutzen und Leistung intensiviert. Qwen3.5 stellt einen bedeutenden Sprung nach vorne dar, indem es Durchbrüche in multimodalem Lernen, architektonischer Effizienz, Skalierung des Reinforcement Learning und globaler Zugänglichkeit integriert, um Entwickler und Unternehmen mit beispielloser Leistungsfähigkeit und Effizienz auszustatten.

## Highlights

Qwen3.5 bringt die folgenden Verbesserungen:

- **Einheitliche Vision-Sprache-Grundlage**: Das Early-Fusion-Training auf multimodalen Tokens erreicht generationsübergreifende Parität mit Qwen3 und übertrifft Qwen3-VL-Modelle in Benchmarks für Argumentation, Code, Agenten und visuelles Verständnis.

- **Effiziente hybride Architektur**: Gated Delta Networks kombiniert mit einer spärlichen Mixture-of-Experts liefern Inferenz mit hohem Durchsatz bei minimaler Latenz und minimalen Kosten.

- **Skalierbare RL-Generalisierung**: Reinforcement Learning wurde auf Millionen-Agent-Umgebungen mit progressiv komplexen Aufgabenverteilungen für robuste Anpassungsfähigkeit skaliert.

- **Globale Sprachabdeckung**: Erweiterte Unterstützung für 201 Sprachen und Dialekte für eine inklusive, weltweite Bereitstellung mit nuanciertem kulturellen und regionalen Verständnis.

- **Trainingsinfrastruktur der nächsten Generation**: Nahezu 100 % multimodale Trainings-Effizienz im Vergleich zu reinem Texttraining und asynchrone RL-Frameworks für massiv skalierbare Agenten-Frameworks und Umgebungsorchestrierung. 
...
<tbody>
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Wissen</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Anweisungsbefolgung</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Langer Kontext</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Argumentation</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Allgemeiner Agent</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Suchagent³</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Mehrsprachigkeit</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Code-Agent</td></tr>
<tr>
...
* Leere Zellen (--) weisen auf noch nicht verfügbare oder nicht anwendbare Werte hin.<br>
</p>
...
<tbody>
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">STEM und Rätsel</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Allgemeiner VQA</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Texterkennung und Dokumentenverständnis</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Räumliche Intelligenz</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Videoverständnis</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Visueller Agent</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Medizinischer VQA</td></tr>
<tr>
...
<p style="margin-top:12px;font-size:11px;color:#888">
* MathVision: Die Punktzahl unseres Modells wurde mit einem festen Prompt bewertet, z. B. „Please reason step by step, and put your final answer within \boxed{}." Für andere Modelle berichten wir die höhere Punktzahl zwischen Durchläufen mit und ohne \boxed{}-Formatierung.<br>
* BabyVision: Die Punktzahl unseres Modells wird mit aktivem CI (Code Interpreter) angegeben; ohne CI beträgt das Ergebnis 43,3.<br>
* V*: Die Punktzahl unseres Modells wird mit aktivem CI (Code Interpreter) angegeben; ohne CI beträgt das Ergebnis 91,1.<br>
* Leere Zellen (--) weisen auf noch nicht verfügbare oder nicht anwendbare Werte hin.<br>
</p>
