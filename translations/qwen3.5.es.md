...
En los últimos meses, hemos intensificado nuestro esfuerzo en el desarrollo de modelos fundacionales que ofrecen una utilidad y un rendimiento excepcionales. Qwen3.5 representa un avance significativo, integrando innovaciones en aprendizaje multimodal, eficiencia arquitectónica, escala de aprendizaje por refuerzo y accesibilidad global, para dotar a los desarrolladores y a las empresas de una capacidad y eficiencia sin precedentes.

## Aspectos destacados

Qwen3.5 incorpora las siguientes mejoras:

- **Base Visión-Lenguaje unificada**: El entrenamiento con fusión temprana sobre tokens multimodales alcanza la paridad cross-generacional con Qwen3 y supera a los modelos Qwen3-VL en los benchmarks de razonamiento, código, agentes y comprensión visual.

- **Arquitectura híbrida eficiente**: Las Gated Delta Networks combinadas con una Mixture-of-Experts dispersa ofrecen inferencia de alto rendimiento con latencia y coste mínimos.

- **Generalización RL escalable**: El aprendizaje por refuerzo se ha escalado a entornos con millones de agentes y distribuciones de tareas progresivamente complejas para una adaptabilidad robusta al mundo real.

- **Cobertura lingüística global**: Soporte ampliado a 201 idiomas y dialectos, que permite un despliegue inclusivo a nivel mundial con una comprensión cultural y regional matizada.

- **Infraestructura de entrenamiento de nueva generación**: Eficiencia de entrenamiento multimodal cercana al 100 % en comparación con el entrenamiento solo de texto, y frameworks RL asíncronos que soportan infraestructuras de agentes a gran escala y orquestación de entornos. 
...
<tbody>
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Conocimiento</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Seguimiento de instrucciones</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Contexto largo</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Razonamiento</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Agente general</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Agente de búsqueda³</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Multilingüismo</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Agente de código</td></tr>
<tr>
...
* Las celdas vacías (--) indican puntuaciones aún no disponibles o no aplicables.<br>
</p>
...
<tbody>
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">STEM y enigmas</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">VQA general</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Reconocimiento de texto y comprensión de documentos</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Inteligencia espacial</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Comprensión de vídeo</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">Agente visual</td></tr>
<tr>
...
<tr><td colspan="7" style="padding:8px 12px;font-weight:600;color:#7c3aed;border-bottom:1px solid #e5e7eb;background:#faf5ff">VQA médico</td></tr>
<tr>
...
<p style="margin-top:12px;font-size:11px;color:#888">
* MathVision: la puntuación de nuestro modelo se evalúa con un prompt fijo, por ejemplo « Please reason step by step, and put your final answer within \boxed{}. » Para los demás modelos, informamos de la puntuación más alta entre las ejecuciones con y sin el formato \boxed{}.<br>
* BabyVision: la puntuación de nuestro modelo se reporta con CI (intérprete de código) activado; sin CI, el resultado es 43.3.<br>
* V*: la puntuación de nuestro modelo se reporta con CI (intérprete de código) activado; sin CI, el resultado es 91.1.<br>
* Las celdas vacías (--) indican puntuaciones aún no disponibles o no aplicables.<br>
</p>
