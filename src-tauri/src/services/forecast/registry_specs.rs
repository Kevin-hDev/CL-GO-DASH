...
pub const FORECAST_RUNTIMES: &[ForecastRuntimeSpec] = &[
    ...
    rt("toto-2.0-4m", "toto-2", K::LocalToto, multiseries()),
    rt("toto-2.0-22m", "toto-2", K::LocalToto, multiseries()),
    rt("toto-2.0-313m", "toto-2", K::LocalToto, multiseries()),
    rt("toto-2.0-1b", "toto-2", K::LocalToto, multiseries()),
    rt("toto-2.0-2.5b", "toto-2", K::LocalToto, multiseries()),
    rt(
        "moirai-2.0-r-small",
        "moirai-2",
        K::LocalMoirai,
